...
# 프로젝트 후기
 ...
 처음이 많았고, 배운건 더 많은 프로젝트였습니다.
 
 처음으로 현업자님의 요구사항에 맞춰서 기능을 설계하고, 사용자를 생각하며 새로운 기술을 배우고 도전해본 프로젝트였습니다.
 
 새로운 기술을 배우고, 실패하고 더 나은 기술을 찾아 적용해보는 실패의 연속이였고, 팀원들과 물리적으로 떨어져있어 소통의 한계가 있었습니다.
 
 하지만 사용자가 더 편하게, 더 효율적으로 문제해결을 하게 하자는 같은 목표를 가지고 서로 끊임없이 도전하고 힘을 모을 수 있었습니다. 
 
 열심히 공부한 머신러닝 모델이 실패하더라도 서로 독려하며 더 좋은 기술을 함께 찾고, 응원해준 팀원들 덕에 포기하지 않고 프로젝트에 참여할 수 있었고, 소통의 한계가 존재해도 밤새 질문을 받아주고 같이 고민해준 팀원에게 미안해서라도 더 효율적으로 소통하기위해 노력했었습니다.
 
 진짜 쓰고싶은 말이 많지만 모두가 자신의 역할에 최선을 다해 도전하고, 누구 한명 포기하지않고 프로젝트 완성도를 높이기 위해 노력한 결과를 1등을 보답받을 수 있어서 너무 행복했습니다.
