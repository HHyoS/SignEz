...
import com.kgh.signezprototype.data.dao.*
import com.kgh.signezprototype.data.entities.*

/**
 * Database class with a singleton INSTANCE object.
 */
@Database(entities = [AnalysisResult::class, ErrorModule::class, ErrorImage::class, Signage::class, Cabinet::class], version = 1, exportSchema = false)
