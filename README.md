...
# 프로젝트 후기
 ...
 열심히 공부한 머신러닝 모델이 실패하더라도 서로 독려하며 더 좋은 기술을 함께 찾고, 응원해준 팀원들 덕에 포기하지 않고 프로젝트에 참여할 수 있었고,
 
 소통의 한계가 존재해도 밤새 질문을 받아주고 같이 고민해준 팀원에게 미안해서라도 더 효율적으로 소통하기위해 노력했었습니다.
 
 진짜 쓰고싶은 말이 많지만 모두가 자신의 역할에 최선을 다해 도전하고, 누구 한명 포기하지않고 프로젝트 완성도를 높이기 위해 노력한 결과를 1등을 보답받을
